...
class LibraryLoader {
  ...
  static DbResult<DynamicLibrary, DbError> _loadUnixLibrary(String platform) {
    final libraryPaths = platform == 'linux' 
        ? _getLinuxServerPaths() 
        : _getMacOSServerPaths();
  ...
  static DbResult<DynamicLibrary, DbError> _loadOtherPlatforms(String platform) {
    ...
    return Err(DbError.ffi(
      ...
      cause: 'dart_db is optimized for Linux and macOS. Attempted: ${attemptedPaths.join(', ')}',
    ));
  }
