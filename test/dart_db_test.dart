...
void main() {
  group('Dart DB Library Loading', () {
    test('should attempt to load native library', () {
      ...
      if (result.isOk) {
        ...
        print('ℹ️ Library loading failed as expected (macOS with Linux binary): ${error.message}');
      }
    });
  });
  ...
  group('Dart DB Core Operations', () {
    ...
    setUpAll(() {
      ...
      if (testResult.isOk) {
        ...
        print('⚠️ Native library not available - skipping core operation tests');
    ...
    test('should store and retrieve string data', () {
      ...
      expect(putResult.isOk, isTrue, 
        reason: 'Should store data successfully');
    ...
    test('should handle post operation (create only)', () {
      ...
      expect(postResult1.isOk, isTrue, 
        reason: 'First post should succeed');
    ...
    test('should handle patch operation (partial update)', () {
      ...
      expect(patchResult.isOk, isTrue,
        reason: 'Patch should succeed');
    ...
    test('should check key existence', () {
      ...
      notExistsResult.when(
        ...
        err: (error) => fail('Exists check for missing key should work: $error'),
      );
    });
  ...
  group('Dart DB Binary Verification', () {
    test('should find liboffline_first_core.so in project directory', () {
      final libPath = '/Volumes/Data/Private/04_Librarys/dart_db/liboffline_first_core.so';
